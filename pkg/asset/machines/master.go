...
func (m *Master) Generate(dependencies asset.Parents) error {
	...
	case alibabacloudtypes.Name:
		...
		machines, err = alibabacloud.Machines(clusterID.InfraID, ic, &pool, "master", masterUserDataSecretName, installConfig.Config.Platform.AlibabaCloud.Tags)
		if err != nil {
	...
	case baremetaltypes.Name:
		...
		machines, err = baremetal.Machines(clusterID.InfraID, ic, &pool, string(*rhcosImage), "master", masterUserDataSecretName)
		if err != nil {
			return errors.Wrap(err, "failed to create master machine objects")
		}
