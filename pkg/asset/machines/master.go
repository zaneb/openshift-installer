...
func (m *Master) Generate(dependencies asset.Parents) error {
	...
	case alibabacloudtypes.Name:
		...
		machines, err = alibabacloud.Machines(clusterID.InfraID, ic, &pool, "master", "master-user-data-managed", installConfig.Config.Platform.AlibabaCloud.Tags)
		if err != nil {
	...
	case ibmcloudtypes.Name:
		...
		machines, err = ibmcloud.Machines(clusterID.InfraID, ic, &pool, "master", "master-user-data-managed")
		if err != nil {
			return errors.Wrap(err, "failed to create master machine objects")
		}
